...
if __name__ == "__main__":
    # xmin, fmin, neval, coords = sdsearch(fH, dfH, np.array([[1.3], [2.0]]), 1e-6)
    xmin, fmin, neval, coords = sdsearch(fS, dfS, np.array([[-5.0], [5.0]]), 1e-6)
    # xmin, fmin, neval, coords = sdsearch(fSDP, dfSDP, np.array([[-5.0], [5.0]]), 1e-6)
    print()
